...
contains
  ...
  !!       - direct mergeing with restriction is not very attractive, as lap is
  ...
  !> \brief applies Jaccobi smoother
  !!
  !! \f$ \mathrm{div = \nabla\cdot\phi } \f$
  !! \note - Null-Setzen am Rand nicht notwendig, da Startindizes entsprechend gewählt sind!        

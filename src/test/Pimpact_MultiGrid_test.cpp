...
using D2 = Pimpact::Space<ST,OT,2,dimension,4>;
using D3 = Pimpact::Space<ST,OT,3,dimension,4>;

using CSpace2DT = Pimpact::Space<ST,OT,2,dimension,2>;
using CSpace3DT = Pimpact::Space<ST,OT,3,dimension,2>;

...
template class MultiField< CompoundField< MultiHarmonicField< VectorField< Space<double,int,4,2> > >, MultiHarmonicField< ScalarField< Space<double,int,4,2> > > > >;
template class MultiField< CompoundField< MultiHarmonicField< VectorField< Space<double,int,4,4> > >, MultiHarmonicField< ScalarField< Space<double,int,4,4> > > > >;

...
extern template class LinearProblem< MultiField <MultiHarmonicField< ScalarField< Space<double,int,4,2> > > > >;
extern template class LinearProblem< MultiField <MultiHarmonicField< ScalarField< Space<double,int,4,4> > > > >;
...
extern template class LinearProblem< MultiField <MultiHarmonicField< VectorField< Space<double,int,4,2> > > > >;
extern template class LinearProblem< MultiField <MultiHarmonicField< VectorField< Space<double,int,4,4> > > > >;

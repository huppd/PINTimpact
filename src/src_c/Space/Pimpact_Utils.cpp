...
std::string Pimpact::toString( Pimpact::F type ) {
	switch( type ) {
		case Pimpact::F::U : return( "U" );
		case Pimpact::F::V : return( "V" );
		case Pimpact::F::W : return( "W" );
		case Pimpact::F::S : return( "S" );
	}
	return( "" ); // prevent compiler warning
}
...
Pimpact::F& operator++( Pimpact::F& c ) {
	switch( c ) {
		case Pimpact::F::U   : return( c = Pimpact::F::V );
		case Pimpact::F::V   : return( c = Pimpact::F::W );
		case Pimpact::F::W   : return( c = Pimpact::F::end );
		case Pimpact::F::end : return( c = Pimpact::F::end );
		case Pimpact::F::S   : return( c = Pimpact::F::end );
	}
	return( c );
}

...
public:
  ...
  */
  ...
  virtual NOX::Abstract::Vector& abs(const NOX::PIMPACT::Vector& y) = 0;
  ...
  */
  ...
  virtual NOX::Abstract::Vector& operator=(const NOX::PIMPACT::Vector& y) = 0;
  ...
  */
  ...
  virtual NOX::Abstract::Vector& reciprocal(const NOX::PIMPACT::Vector& y) = 0;
  ...
  */
  ...
  virtual NOX::Abstract::Vector& scale(const NOX::PIMPACT::Vector& a) = 0;
  ...
  */
  ...
  virtual NOX::Abstract::Vector& update(double alpha, const NOX::PIMPACT::Vector& a, double gamma = 0.0) = 0;
  ...
  */
  virtual NOX::Abstract::Vector& update(double alpha, const NOX::Abstract::Vector& a,
			 ...
			 double gamma = 0.0) = 0;
  virtual NOX::Abstract::Vector& update(double alpha, const NOX::PIMPACT::Vector& a,

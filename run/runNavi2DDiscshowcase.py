...
case_consts = ' --linSolName="GMRES" --flow=1 --domain=1 --force=4 --radius=0.1 --rotation=2. --nfe=33   --npx='+str(npx)+' --npy='+str(npy)+' --tolNOX=1.e-2 --tolNF=1.e-4 --tolBelos=1.e-6  --maxIter=5  --lx=6. --ly=2. --xm='+str(1./6.) + '  '

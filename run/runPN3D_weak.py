...
' --nf=4   --baseflow=22 --flow=0 --re=400 --alpha2=9 --tolNOX=1.e-6  --tolBelos=1.e-1 --tolInnerBelos=1.e-3 --maxIter=20  --lx=30. --ly=30. --ly=30 --initZero=0 --numCycles=2 --domain=0 ']
...
for case in range(2):
	...
	for n in ns:
		...
		os.system(' rm ./* -r -v  ')
		case_para = ' --nx='+str(32*n+1)+' --ny='+str(16*n+1)+' --nz='+str(32*n+1)+' --npx='+str(n)+' --npy='+str( max(n/2,1) )+' --npz='+str(n)+' --maxGrids='+str(2)+' '

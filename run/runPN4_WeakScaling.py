        ...
        for re in res:
            ...
            for alpha2 in alpha2s:
                ...
                for i in range(len(npxs)):
                    ...
                    os.system(' rm ./* -r -v  ')
                    case_para = ' --precType='+str(precType)+' --lx='+str(4*npxs[i])+' --nx='+str(npxs[i]*2*2**n+1)+' --ny='+str(2**n+1)+' --nt='+str(npts[i]*2**n)+' --re='+str(re)+' --alpha2='+str(alpha2)+' --npx='+str(npxs[i])+' --npy='+str(npys[i])+' --npt='+str(npts[i])
